...
class TesseractTrainer():
    def __init__(self):
        ...
        self.fontName = "Arial"
        self.directory = "C:/WebScraping/images"
        # self.directory1 = "C:/WebScraping/images1"
    ...
    def createTrainingFile(self, prefix):
        ...
        p = subprocess.Popen(["tesseract", prefix + ".tiff", "nobatch", "box.train"], stdout = subprocess.PIPE, stderr = subprocess.PIPE)
        returnValue = stdout_value = p.communicate()[1]
        returnValue = returnValue.decode("utf-16")
